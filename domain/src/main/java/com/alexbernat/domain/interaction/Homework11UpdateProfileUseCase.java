 ...
 */
public class Homework11UpdateProfileUseCase extends UseCase<Homework11ProfileModel, Void> {
    ...
    protected Observable<Void> buildUseCase(Homework11ProfileModel homework11ProfileModel) {
        ...
        return Homework11RestService.getInstance().editProfile(homework11ProfileModel.getStringId(), profile);
    }
}
